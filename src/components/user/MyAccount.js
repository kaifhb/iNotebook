...
const MyAccount = () => {
  ...
  const getUserDetails = async (userToken) => {
    ...
    setUserDetails({
      _id: respJson._id,
      loginName: respJson.name,
      loginEmail: respJson.email,
    });
  };
    ...
    <form onSubmit={handleOnSubmit}>
      ...
      <div className="mb-3">
        ...
        <div id="passHelp" className="form-text">
          leave it blank if you do not want to change password
        </div>
      </div>
      <div className="mb-3">
        <label htmlFor="loginCPassword" className="form-label">
          Confirm Password
        </label>
        <input
          type="password"
